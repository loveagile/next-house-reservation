...
const ReservationGroupSearchBar: React.FC<ThisFCProps> = ({
  totalCounts,
  setKeyword,
}) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex border-b-[1px] pb-3 border-[#eee] mb-5">
        ...
        <div className="ml-auto flex items-center gap-1">
          <InputField id="keyword" placeholder="キーワード" control={control} className="w-[300px]" />
...
export default ReservationGroupSearchBar;
