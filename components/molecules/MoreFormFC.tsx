...
const MoreFormFC: React.FC<ThisFCProps> = ({ formData, index, value, error = "", onFormChange, disabled = false }) => {
  ...
  return (
    <div className="w-full mt-8">
      ...
      {detail && <p className="text-xs ml-3 mb-2">{detail}</p>}
