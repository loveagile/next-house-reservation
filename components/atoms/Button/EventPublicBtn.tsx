...
interface ThisFCProps {
  id: number;
  eventStatus: IStatusProps;
  setEventStatus: (eventStatus: IStatusProps) => void;
  isBack?: boolean;
}

const EventPublicBtn: React.FC<ThisFCProps> = ({ id, eventStatus, setEventStatus, isBack = false }) => {
      ...
      >
        ...
        <DialogContent sx={{
          ...
          <RadioGroup name="use-radio-group"
            defaultValue={eventStatus.status}
            ref={radioGroupRef}
          ...
          >
            <div className="border-[1px] rounded border-[#eee] relative">
              ...
              <div className="flex flex-col px-6 py-4 gap-1">
                ...
                <FormControlLabel control={<Checkbox defaultChecked={eventStatus.isIemiru}
